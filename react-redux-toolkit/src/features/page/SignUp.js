                ...
                <Col sm={12} md={12}>
                    <div className="m-4">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div class="mb-4">
                                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tên Người Dùng</label>
                                <input type="text" id="name" {...register('name', { required: true })} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="abc" required="" />

                                {errors.name && <p class="mt-2 text-sm text-red-600 dark:text-red-500"><span class="font-medium">Lỗi!</span> Không để trống</p>}
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="flex flex-col space-y-5 w-full">
                                <button type="submit" class="w-full bg-red-600 rounded-3xl p-3 text-white font-bold transition duration-200 hover:bg-red-800">Đăng Ký</button>
                                ...
                                <button class="w-full border-red-600 hover:border-red-800  border-[1px] rounded-3xl p-3 text-red-600 font-bold transition duration-200"><Link to={`/signin`} className="text-red-600 hover:text-red-800" >Đăng Nhập</Link></button>
                            </div>
