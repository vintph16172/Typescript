            ...
            <div className="container mx-auto px-8">
                <div className="w-full flex flex-col md:flex-row py-6">
                    <div className="flex-1 mb-6 text-black ">
                        <a className="text-pink-600 flex justify-center no-underline hover:no-underline font-bold text-2xl lg:text-4xl" href="#">
                            ...
                            LANDING */}
                            <img src="../src/img/logo.png" alt="" className='h-20' />
                        </a>
                    </div>
